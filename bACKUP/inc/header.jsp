      ...
      <div class="header-new">
        ...
        <div class="col-right">
          ...
          <nav id="nav-new">
            ...
            <ul class="nav-new">
              <li class="active">
                <a href="dep-plan0.html">연간업무계획</a>
              </li>
            </ul>
          </nav>
          <!-- //Nav pc/모바일 화면 메뉴 및 표기 -->
	...
	<section class="sub-container" >
		...
		<div class="mobile-lnb xs-show">
			<select id="lnbOperationSelect" class="" onchange="goLnb(this, '', '');">
				<option selected="" value="">조직/인력 구성 및 업무 분장</option>
				<option value="">부서별 업무 현황</option>
			</select>
		</div>
		<!-- // 모바일 서브 화면 메뉴 -->
      ...
      <div class="lnb xs-hidden">
				...
				<div class="lnb-smenu active progress">
					...
					<a href="dep-plan1-2.jsp">
						...
						<p class="">조직/인력 구성 및 업무 분장 </p>
					</a>
				</div>
        
				<!-- 하위 메뉴 존재할 시 .lnb-smenu 에 .op 클래스 추가 -->
				<div class="lnb-smenu active progress op">

					<!-- 메뉴2 -->
					<a href="dep-plan2-1-1_admin.jsp">
						<p class="active">부서별 업무 현황</p>
					</a>

					<!-- 메뉴3 / 마지막 하위메뉴에는 .lnb-3Smenu 와 li 에 .active 클래스 추가  -->
					<div class="lnb-3Smenu active">
						<ul>
							<li class="active">
