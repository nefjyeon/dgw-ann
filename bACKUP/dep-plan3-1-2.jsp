...
<!--//header -->
        ...
        <div class="table-responsive">
          ...
          <h3>부서별 업무 현황</h3>
            ...
            <div class="subTab"><a href="dep-plan3-1-1.html">업무 개요 및 성과지표 목표</a></div> 
						<div class="subTab active"><a href="dep-plan3-1-2.html">일정 및 집행 계획</a></div> 
            ...
            <div class="rTab"><a href="">2024년</a></div>
					...
					<div class="tabBox">
						<h4>세부 업무별 소요 예산 집행 계획(단위: 천원)</h4>
						<div class="table-responsive">
							<table class="headTbl bdl rowBdb"> 
							<!-- .rowBdb 는 교무처 외 나머지 맨 마지막 td 보더바텀값 조정용 클래스-->
								<colgroup>
