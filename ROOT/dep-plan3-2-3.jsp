...
<!--//header -->	
        ...
        <div class="table-responsive">
          ...
          <h3>기관평가인증</h3>
              ...
              <tbody>
                <tr>
                  ...
                  <td>미래지향적 교육과정 내실화 및 질 관리 체계구축</td>
								...
								<tr>
									<th>평가요소</th>
                  <td colspan="3">교육의 질 관리 및 성과 관리 강화</td>
                </tr>
								<tr>
									<th>협업부서</th>
                  <td>학생과, 학생상담센터</td>
										...
										<table class="headTbl bdl heiTbl" style="margin-bottom:0; border-top:none;">
											...
											<tbody>
												...
												<tr>
													...
													<td class="bdb0">규정 제개정 절차 준수</td>
													<td class="bdb0">규정 준수율</td>
												</tr>
                  ...
                  <td>예산사업</td>
						...
						<div style="text-align: right; margin-top: 20px">
							<a href="dep-plan3-2-2.html" class="button grey size-mid min-width">수정</a>
            ...
            <div class="tab active"><a href="dep-plan3-2-3.jsp">업무 개요 및 성과지표 목표</a></div>
						<div class="tab"><a href="dep-plan3-1-2.jsp">일정 및 집행 계획</a></div>
						<div class="tab"><a href="dep-plan3-1-3.jsp">분석(리스크 요인 및 대응 방안)</a></div>
          </div>
							...
							<!-- .rowBdb 는 교무처 외 나머지 맨 마지막 td 보더바텀값 조정용 클래스-->
								...
								<thead>
									<tr>
										...
										<th rowspan="2">비고</th>
										<th rowspan="2"><a href="#" onclick="fn_addFile(this, 'D_ANALYSIS_DEV_Q1_1'); return false;" class="btn low blue" title="추가">+</a></th>
									</tr>
									<tr>
										<th>달성값</th>
										<th>목표값</th>
